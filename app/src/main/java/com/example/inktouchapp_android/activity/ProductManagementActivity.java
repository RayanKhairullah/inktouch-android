...
import com.example.inktouchapp_android.adapter.ProductManagementAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(v -> {
            if (isDeletingMode) {
                ...
                productAdapter.getSelectedProducts().clear();
        ...
        fabDelete.setOnClickListener(v -> {
            ...
            if (selected != null && !selected.isEmpty()) {
                ...
                Toast.makeText(this, "Pilih produk yang ingin dihapus", Toast.LENGTH_SHORT).show();
            }
        });
